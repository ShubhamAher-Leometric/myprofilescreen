...
import '../agent_location_property/featured_property_search_list.dart';
import '../agent_location_property/location_listing.dart';
import '../agent_location_property/location_property.dart';
import '../agent_location_property/property_details.dart';
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => AgentNotificationPage()),
                            );
                          },
                          child: Container(
                            height: 49,
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => AgentLocationListingScreen()),
                      );
                    },
                    child: Text(
                      'explore',
                      style: TextStyle(fontSize: 16, color: agentapptextcolor2),
                    ),
                  ),
                ],
              ),
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AgentFeaturedPropertySearchListScreen()));
                    },
                    child: Text(
                      'explore',
                      style: TextStyle(fontSize: 16, color: agentapptextcolor2),
