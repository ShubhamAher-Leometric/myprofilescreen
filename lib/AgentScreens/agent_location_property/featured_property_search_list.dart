...
class AgentFeaturedPropertySearchListScreen extends StatefulWidget {
  const AgentFeaturedPropertySearchListScreen({super.key});

  @override
  State<AgentFeaturedPropertySearchListScreen> createState() => _AgentFeaturedPropertySearchListScreenState();
}

class _AgentFeaturedPropertySearchListScreenState extends State<AgentFeaturedPropertySearchListScreen> {
