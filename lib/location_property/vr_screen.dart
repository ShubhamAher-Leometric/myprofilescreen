...
class _VideoPlayerPageState extends State<VideoPlayerPage>
  ...
  void onViewPlayerCreated(
    ...
    _viewPlayerController.loadVideo(
      videoUrl:
      'https://github.com/ShubhamAher-Leometric/myproperty/blob/14f81c20581800305e3041f1973ff049568a07ca/assets/video_files/360_vr_master_series___free_download____pebbly_beach_headland%20(1440p).mp4',
    ).then((_) {
      _viewPlayerController.play(); // Autoplay when the video is loaded
      setState(() {
        _isPlaying = true;
      });
    });
  ...
  void onReceiveEnded(bool isFinished) {
    if (isFinished) {
      _viewPlayerController.seekTo(0).then((_) {
